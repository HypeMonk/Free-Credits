# Free credits Setup Guide (JustDOWork)

## Step 1: Get Your API Key

1. Go to the [JustdoWork Portal](https://api.justwoker.icu/register?aff=cBBj) (Signup with this link.. you will get some bonus)
2. Sign in with your any GitHub account. (must be older than 1 year)
3. Create an account and navigate to the **Dashboard** tab. (you will upto 100$ credits in wallet)
...
​{
  "env": {
    ...
    "ANTHROPIC_DEFAULT_FABLE_MODEL": "claude-opus-4.8-thinking[1m]",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "claude-opus-5-thinking[1m]",
