# Free credits Setup Guide (KKtoken)

## Step 1: Get Your API Key

1. Go to the [Tabitoken Portal](https://tabitoken.com/sign-up?aff=qd8S) (Signup with this link.. you will get some bonus)
2. Sign in with your any GitHub account. (must be older than 1 year)
3. Create an account and navigate to the **Dashboard** tab. (you will upto 125$ credits in wallet)
